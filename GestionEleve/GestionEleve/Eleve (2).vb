...
Public Class Eleve
    ...
    Private Sub btn_Edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Edit.Click
        ...
        If MessageBox.Show("Voulez-vous vraiment Mettre a jours l'enregistrement?", "ETES-VOUS SURE?", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
            Try
                Cmd.CommandText = "UPDATE Eleve SET Matricul='" & txt_Matricul.Text & "', Nom='" & txt_Nom.Text & "',Postnom='" & txt_Postnom.Text & "',Sexe='" & cb_Sexe.Text & "',Datedenaissance='" & txt_Datedenaissance.Text & "',Lieudenaissance='" & txt_Lieudenaissance.Text & "',Nomdupere='" & txt_Nomdupere.Text & "',Nomdelamere='" & txt_Nomdelamere.Text & "',Religion='" & txt_Religion.Text & "',Ecoledeprov='" & txt_Ecoledeprov.Text & "',Inscritdans='" & cb_Inscritdans.Text & "',Addresse='" & txt_Addresse.Text & "',Tel='" & txt_Tel.Text & "'"
                Cmd.Connection = cn
                Cmd.ExecuteNonQuery()
                cn.Close()
